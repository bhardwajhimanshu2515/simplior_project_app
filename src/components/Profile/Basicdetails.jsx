...
export class Basicdetails extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      img:
        "https://vignette.wikia.nocookie.net/dbxfanon/images/f/fd/Link.png/revision/latest?cb=20160424022916",
    };
  }
  handleChange = (e) => {
  ...
  submit = (e) => {
    ...
    e.preventDefault();
    let data;
    if (localStorage.getItem("userInfoId")!=="undefined") {
      data = {
        ...
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          ...
          >
            ...
            <div>
              ...
              <p className="contact">{this.state.emailAddress}</p>
            </p> */}
              <p className="contact-head">
